          ...
          <div className="col-span-6 flex flex-col gap-[36px]">
            ...
            <label className="flex flex-col gap-[5px]">
              <Description
                ...
                title={"About"}
              />
              <textarea placeholder="About" rows={10} name="about" required className="w-full outline-none placeholder:text-gray-200 font-medium rounded p-[13px] resize-none font-kubmh text-sm border-[.5px] border-gray-100"></textarea>
            </label>
          </div>
