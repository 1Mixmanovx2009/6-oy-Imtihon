          ...
          <div className="col-span-6 flex flex-col gap-[36px]">
            <label className="flex flex-col gap-[5px]">
              <Description
                ...
                title={"Full Name"}
              />
              <Input defaultValue={teacher.fullName} required name="newFullName" placeholder="Full Name" type="text"/>
            </label>
            ...
            <label className="flex flex-col gap-[5px]">
              <Description
                ...
                title={"Email Address"}
              />
              <Input defaultValue={teacher.email} required name="newEmail" placeholder="Email address" type="email"/>
            </label>
            ...
            <label className="flex flex-col gap-[5px]">
              <Description
                ...
                title={"Subject"}
              />
              <select required className="w-full outline-none font-medium rounded p-[13px] font-kubmh text-sm border-[.5px] border-gray-100 leading-[17.36px]" name="newSubject">
            ...
            <label className="flex flex-col gap-[5px]">
              <Description
                ...
                title={"About"}
              />
              <textarea placeholder="About" rows={10} defaultValue={teacher.about} name="newAbout" required className="w-full outline-none placeholder:text-gray-200 font-medium rounded p-[13px] resize-none font-kubmh text-sm border-[.5px] border-gray-100"></textarea>
            </label>
          </div>

          <div className="col-span-6 flex flex-col gap-[36px]">
            <label className="flex flex-col gap-[5px]">
              <Description extraStyle={
                  "font-medium text-gray-200 text-sm leading-[17.36px]" } title={"Class"}/>
              <select required className="w-full outline-none font-medium rounded p-[13px] font-kubmh text-sm border-[.5px] border-gray-100 leading-[17.36px]" name="newClasses">
                <option value="" defaultValue>
                  Class
                </option>
